This is a brewery rating application made by Kunz Leigh & Associates for the Beer City Code Firebae workshop to illustrate how to use Firebase to create a robust web application.
